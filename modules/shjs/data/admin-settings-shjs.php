...
row: 0
    field: title
        <?php print t("Syntax Highlighting Configuration") ?>
    field;
    ...
    field: content
        <?php
            ...
            {
                if(JarisCMS\Setting\Save("display_rule", $_REQUEST["display_rule"], "shjs"))
                {
                    JarisCMS\Setting\Save("pages", $_REQUEST["pages"], "shjs");
            ...
            $shjs_settings = JarisCMS\Setting\GetAll("shjs");

            $parameters["name"] = "shjs-settings";
            $parameters["class"] = "shjs-settings";
            $parameters["action"] = JarisCMS\URI\PrintURL(JarisCMS\Module\GetPageURI("admin/settings/shjs", "shjs"));
            ...
            $fields_pages[] = array("type"=>"radio", "checked"=>$shjs_settings["display_rule"], "name"=>"display_rule", "id"=>"display_rule", "value"=>$display_rules);
            $fields_pages[] = array("type"=>"uriarea", "name"=>"pages", "label"=>t("Pages:"), "id"=>"pages", "value"=>$shjs_settings["pages"]);
