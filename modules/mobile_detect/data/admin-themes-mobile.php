...
row: 0
    ...
    field: content
        <?php
            ...
            {
                Setting\Save("mobile_theme", $_REQUEST["theme"] . "/mobile", "mobile_detect");

                System\AddMessage(t("Changes successfully saved."));

                System\GoToPage("admin/themes/mobile");
            }
        ?>

        <form class="themes" action="<?php print URI\PrintURL(Module\GetPageURI("admin/themes/mobile", "mobile_detect")); ?>" method="post">
        ...
        <?php
            ...
            $current_theme = Setting\Get("mobile_theme", "mobile_detect");
            ...
            {
                if(
                    file_exists("themes/" . $theme_path . "/mobile/info.php")
                )
                {
            ...
            {
                System\AddMessage(t("None of the current themes has mobile support."));
            }
