...
CodeMirrorUI.prototype = {
  ...
  initialize: function(textarea, options, mirrorOptions) {
    var defaultOptions = {
      ...
      path: 'js',
      buttons: ['search', 'undo', 'redo', 'jump', 'reindentSelection', 'reindent', 'fullscreen','about'],
    ...
    this.buttonDefs = {
      ...
      'fullscreen': ["Switch/Unswitch Fullscreen Mode", "fullscreen", this.options.imagePath + "/fullscreen.png", this.fullscreen],
  ...
  fullscreen : function() {
    ...
    var menu = $(this.textarea).prev("div");
    var editor = $(this.textarea).next("div.CodeMirror");
    
    if(document.body.style.visibility != "hidden") {
      document.body.style.visibility = "hidden";
      $("body").css("overflow", "hidden");
      container.css("position", "absolute").css("width", $(window).innerWidth()).css("height", $(window).innerHeight()).css("top", (window.pageYOffset?window.pageYOffset:document.body.scrollTop?document.body.scrollTop:document.documentElement.scrollTop) + "px").css("left", "0").css("visibility", "visible");
      editor.css("height", ($(window).innerHeight() - menu.innerHeight()) + "px");
    }
    else {
      document.body.style.visibility = "visible";
      $("body").css("overflow", "visible");
      container.css("position", "relative").css("width", "100%").css("height", "320px").css("top", "0px").css("left", "0px");
